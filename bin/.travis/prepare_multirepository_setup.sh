...
# Run setup
docker-compose exec -T --user www-data app sh -c "vendor/bin/ibexabehat --mode=standard --profile=setup --suite=multirepository -c=\$([ -f behat_ibexa_oss.php ] && echo behat_ibexa_oss.php || echo behat_ibexa_oss.yaml)"
