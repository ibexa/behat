...
return (new Config())
    ->import('behat_ibexa_headless.php')
    ->import('vendor/ibexa/corporate-account/behat_suites.php')
    ->import('vendor/ibexa/dashboard/behat_suites.php')
    ->import('vendor/ibexa/fieldtype-page/behat_suites.php')
    ->import('vendor/ibexa/form-builder/behat_suites.php')
    ->import('vendor/ibexa/page-builder/behat_suites.php')
    ->import('vendor/ibexa/scheduler/behat_suites_experience.php')
    ->import('vendor/ibexa/segmentation/behat_suites.php')
    ->import('vendor/ibexa/site-factory/behat_suites.php')
    ->import('vendor/ibexa/taxonomy/behat_suites_experience.php')
    ->import('vendor/ibexa/workflow/behat_suites_experience.php')
    ->import('vendor/ibexa/activity-log/behat_suites.php')
    ->withProfile((new Profile('regression'))
        ->withSuite((new Suite('setup-experience'))
            ->withContexts(
        ...
        ->withSuite((new Suite('experience'))
            ->withContexts(
                MinkContext::class,
                AdminUpdateContext::class,
            ...
            ->withFilter(new TagFilter('~@broken&&@IbexaExperience'))));
